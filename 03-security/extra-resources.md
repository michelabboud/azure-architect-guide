...
### Free Learning Paths
- [Secure your cloud applications](https://learn.microsoft.com/en-us/training/paths/secure-your-cloud-applications/)
- [AZ-500 Exam Prep](https://learn.microsoft.com/en-us/training/courses/az-500t00)
- [Implement network security](https://learn.microsoft.com/en-us/training/paths/implement-network-security/)
...
- [Azure Security Best Practices](https://www.youtube.com/watch?v=1Y_dGfYKTAE)

### Ignite Sessions
- [What's new in Microsoft Defender](https://ignite.microsoft.com/sessions)
- [Zero Trust Network Security](https://ignite.microsoft.com/sessions)

## AWS to Azure Security Comparison

- [AWS Security vs Azure Security](https://learn.microsoft.com/en-us/azure/architecture/aws-professional/security-identity)
- [AWS Security Hub vs Defender for Cloud](https://learn.microsoft.com/en-us/azure/defender-for-cloud/defender-for-cloud-introduction)
- [AWS WAF vs Azure WAF](https://learn.microsoft.com/en-us/azure/web-application-firewall/overview)
...
- [NIST Cybersecurity Framework on Azure](https://learn.microsoft.com/en-us/azure/compliance/offerings/offering-nist-csf)

## Tools & Utilities

### Security Assessment
- [Microsoft Secure Score](https://security.microsoft.com/securescore)
- [Azure Security Center API](https://learn.microsoft.com/en-us/rest/api/defenderforcloud/)
- [Cloud Security Posture Management](https://learn.microsoft.com/en-us/azure/defender-for-cloud/concept-cloud-security-posture-management)
...
- [Azure Security Blog](https://techcommunity.microsoft.com/t5/azure-security/bg-p/AzureSecurity)
...
- [Network Security Architecture](https://learn.microsoft.com/en-us/azure/architecture/framework/security/design-network)
- [Hub-Spoke Security](https://learn.microsoft.com/en-us/azure/architecture/reference-architectures/hybrid-networking/hub-spoke)
