# Extra Resources: Azure Foundations

## Official Microsoft Documentation

### Azure Fundamentals
- [Azure Documentation](https://learn.microsoft.com/en-us/azure/)
- [Azure Fundamentals](https://learn.microsoft.com/en-us/azure/fundamentals/)
...
### Free Learning Paths
- [Azure Fundamentals (AZ-900)](https://learn.microsoft.com/en-us/training/paths/azure-fundamentals-describe-azure-architecture-services/)
- [Azure Administrator (AZ-104)](https://learn.microsoft.com/en-us/training/paths/az-104-administrator-prerequisites/)
- [Azure Solutions Architect (AZ-305)](https://learn.microsoft.com/en-us/training/courses/az-305t00)

### Foundational Modules
- [Describe core Azure concepts](https://learn.microsoft.com/en-us/training/modules/describe-core-azure-concepts/)
- [Azure subscriptions and management](https://learn.microsoft.com/en-us/training/modules/azure-subscriptions-mgmt-groups/)

## AWS to Azure Migration

### Comparison Guides
- [AWS to Azure Services Comparison](https://learn.microsoft.com/en-us/azure/architecture/aws-professional/services)
- [AWS Professionals Guide to Azure](https://learn.microsoft.com/en-us/azure/architecture/aws-professional/)
- [Multi-cloud with Azure](https://learn.microsoft.com/en-us/azure/cloud-adoption-framework/scenarios/hybrid/arc-enabled-servers/)

### Migration Resources
- [Azure Migrate](https://learn.microsoft.com/en-us/azure/migrate/)
- [Migration Guides](https://learn.microsoft.com/en-us/azure/migrate/migrate-services-overview)

## Videos & Webinars

### Microsoft Learn Shows
- [Azure Friday](https://learn.microsoft.com/en-us/shows/azure-friday/)
- [Azure Fundamentals Video Series](https://www.youtube.com/playlist?list=PLLasX02E8BPDvJhiGx5BHYDXu-9A6e-3E)

### Architecture
- [Azure Architecture Center YouTube](https://www.youtube.com/c/AzureDeveloperCommunity)
...
- [Azure Cloud Shell](https://learn.microsoft.com/en-us/azure/cloud-shell/)

### Development Tools
- [VS Code Azure Extensions](https://marketplace.visualstudio.com/search?target=VSCode&category=Azure)
...
- [Example Workloads](https://learn.microsoft.com/en-us/azure/architecture/example-scenario/)
