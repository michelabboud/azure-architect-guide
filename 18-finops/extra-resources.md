# Extra Resources: FinOps & Cost Management
...
- [Hybrid Benefit](https://learn.microsoft.com/en-us/azure/cost-management-billing/scope-level/)

### Azure Advisor
- [Azure Advisor Documentation](https://learn.microsoft.com/en-us/azure/advisor/)
- [Cost Recommendations](https://learn.microsoft.com/en-us/azure/advisor/advisor-cost-recommendations)

## Microsoft Learn Modules

### Free Learning Paths
- [Control Azure spending and manage bills](https://learn.microsoft.com/en-us/training/paths/control-spending-manage-bills/)
- [Plan and manage Azure costs](https://learn.microsoft.com/en-us/training/modules/plan-manage-azure-costs/)
- [FinOps Foundation](https://learn.microsoft.com/en-us/training/paths/finops-foundation/)

### Hands-on Labs
- [Analyze costs and create budgets](https://learn.microsoft.com/en-us/training/modules/analyze-costs-create-budgets-azure-cost-management/)
- [Configure Azure Advisor](https://learn.microsoft.com/en-us/training/modules/configure-azure-advisor/)

## Videos & Webinars

### Azure Cost Management
- [Cost Management Overview](https://www.youtube.com/watch?v=cost-management-overview)
- [FinOps on Azure](https://www.youtube.com/watch?v=finops-azure)

### Microsoft Ignite Sessions
- [Azure Cost Optimization](https://ignite.microsoft.com/sessions)
- [What's New in Cost Management](https://ignite.microsoft.com/sessions)

## AWS to Azure Cost Comparison

- [AWS Cost Explorer vs Azure Cost Analysis](https://learn.microsoft.com/en-us/azure/cost-management-billing/costs/quick-acm-cost-analysis)
- [AWS Savings Plans vs Azure Savings Plans](https://learn.microsoft.com/en-us/azure/cost-management-billing/savings-plan/)
- [AWS Reserved Instances vs Azure Reservations](https://learn.microsoft.com/en-us/azure/cost-management-billing/reservations/)
...
- [FinOps Certified Engineer](https://learn.finops.org/)

## Tools & Utilities

### Cost Analysis Tools
- [Azure Cost Management + Billing Portal](https://portal.azure.com/#blade/Microsoft_Azure_CostManagement/Menu/overview)
...
### Official Blogs
- [Azure Cost Management Blog](https://techcommunity.microsoft.com/t5/azure-cost-management-blog/bg-p/AzureCostManagementBlog)
- [FinOps Blog](https://www.finops.org/blog/)

### Community Resources
- [FinOps Foundation Slack](https://finopsfoundation.slack.com/)
- [Azure FinOps Community](https://techcommunity.microsoft.com/t5/finops/ct-p/FinOps)
- [r/Azure Subreddit](https://www.reddit.com/r/AZURE/)

## Reference Architectures

- [Well-Architected Cost Optimization](https://learn.microsoft.com/en-us/azure/architecture/framework/cost/)
- [Cost Optimization Design Principles](https://learn.microsoft.com/en-us/azure/architecture/framework/cost/principles)
- [Cost Governance](https://learn.microsoft.com/en-us/azure/cloud-adoption-framework/govern/cost-management/)
