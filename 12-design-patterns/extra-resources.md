# Extra Resources: Cloud Design Patterns

## Official Microsoft Documentation

### Azure Architecture Center
- [Cloud Design Patterns](https://learn.microsoft.com/en-us/azure/architecture/patterns/)
- [Application Architecture Guide](https://learn.microsoft.com/en-us/azure/architecture/guide/)
...
- [Reliability Patterns](https://learn.microsoft.com/en-us/azure/architecture/patterns/category/reliability)
- [Security Patterns](https://learn.microsoft.com/en-us/azure/architecture/patterns/category/security)
- [Performance Patterns](https://learn.microsoft.com/en-us/azure/architecture/patterns/category/performance)
...
- [Design distributed systems](https://learn.microsoft.com/en-us/training/paths/architect-infrastructure-operations/)
- [AZ-305 Exam Prep](https://learn.microsoft.com/en-us/training/courses/az-305t00)

### Hands-on Labs
- [Implement resiliency patterns](https://learn.microsoft.com/en-us/training/modules/implement-resiliency-infrastructure/)
- [Design event-driven solutions](https://learn.microsoft.com/en-us/training/modules/azure-event-grid/)
...
- "Release It!" by Michael Nygard (Pragmatic)
- "Enterprise Integration Patterns" by Hohpe & Woolf (Addison-Wesley)
...
- [Cloud Design Patterns Book (PDF)](https://www.microsoft.com/en-us/download/details.aspx?id=42026)

## Videos & Webinars

### Microsoft
- [Azure Architecture Center YouTube](https://www.youtube.com/c/AzureDeveloperCommunity)
- [Cloud Patterns Deep Dive](https://www.youtube.com/watch?v=cloud-patterns)

### Conference Talks
- [GOTO Conferences](https://www.youtube.com/c/GotoConferences)
- [InfoQ Presentations](https://www.infoq.com/presentations/)
- [QCon Talks](https://qconferences.com/)

## Implementation Libraries

### .NET
- [Polly (Resilience)](https://github.com/App-vNext/Polly)
- [MassTransit (Messaging)](https://masstransit-project.com/)
- [MediatR (CQRS)](https://github.com/jbogard/MediatR)
- [EventStore (Event Sourcing)](https://www.eventstore.com/)

### Java
- [Resilience4j](https://resilience4j.readme.io/)
- [Spring Cloud](https://spring.io/projects/spring-cloud)
- [Axon Framework (CQRS/ES)](https://www.axoniq.io/)

### General
- [Dapr](https://dapr.io/) - Distributed application runtime
- [Envoy](https://www.envoyproxy.io/) - Service proxy

## Azure Services for Patterns
...
### Community Resources
- [Azure Architecture Center GitHub](https://github.com/mspnp)
...
- [Cloud Native .NET](https://github.com/dotnet-architecture/cloud-native)
